...
function ProfileImagePlaceholder() {
  return (
    <div className="w-full aspect-[4/5] max-h-[500px] md:max-h-[550px] bg-gray-200 rounded-[2rem] overflow-hidden flex items-center justify-center relative">
      <span className="text-gray-400 font-medium text-sm">Profile Image</span>
    </div>
  );
}
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-[60%] flex flex-col text-left">
            <h3 className="text-2xl md:text-3xl font-bold text-black mb-6">
              Why I built Tripscops
            </h3>
            
            <p className="text-gray-600 text-base leading-relaxed mb-6">
              I built this to reimagine and streamline how people plan their adventures. From your
              photo, aliens or clean avatar, a real core accords emotional travel plan.
            </p>
            
            <p className="text-gray-600 text-base leading-relaxed mb-10">
              The emotional yet concise insight and built-in recommendations enrich travel
