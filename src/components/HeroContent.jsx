...
function AppStoreButtonPlaceholder() {
  ...
  return (
    <a href="#appstore" onClick={handleDownloadClick} className="bg-black text-white flex items-center gap-3 px-6 py-3 rounded-xl hover:scale-105 transition-transform shadow-lg">
